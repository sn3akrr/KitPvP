...
class Spell{
	...
	public function cast(Player $witch, Entity $victim){
		$spell = $this->getSpell();
		...
		if($victim instanceof Player) $victim->addTitle(TextFormat::OBFUSCATED.TextFormat::RED.TextFormat::BOLD."KKK",TextFormat::GOLD.$witch->getName()." casted ".$this->getName()." on you!", 5, 40, 5);
	}
